...
const ZamaraInputs = ({disabled, errored, label, error, isPassword, onChangeText, value}) => {
  ...
  return (
    <View style={styles.inputcontainer}>
      ...
      <TextInput style={[styles.input,{borderColor: active? "#795548" : errored? "#F97066" : "#D0D5DD"}]} 
